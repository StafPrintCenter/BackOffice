...
export const Route = createFileRoute("/admin/trainings/admin/formations/$id")({
...
function FormationDetail() {
  ...
  return (
    <AdminShell>
      <div className="mb-6"><Button variant="outline" size="sm" onClick={() => navigate({ to: "/admin/formations" })}><ArrowLeft className="h-4 w-4 mr-1" /> Retour</Button></div>
