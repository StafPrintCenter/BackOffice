...
const NAV_GROUPS: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { to: "/newsletter/subscribers", label: "Newsletter", icon: Mailbox, matchPrefixes: ["/admin/newsletter"] },
    ],
  },
  {
    label: "Outils",
    items: [
      ...
      { to: "/reviews/forms", label: "Formulaires d'avis", icon: Form, matchPrefixes: ["/admin/reviews"] },
    ],
  },
  {
    label: "Recruitements",
