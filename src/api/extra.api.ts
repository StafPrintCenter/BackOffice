...
import { seedCategories, seedStats, seedFaqs, seedShortLinks, seedShortLinkClicks, seedMessages, seedReports, seedUsers } from "@/data/seedExtra";
...
export const faqsApi = makeApi<Faq>(seedFaqs);
