...
const NAV_GROUPS: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { to: "/admin/trainings", label: "Formations", icon: GraduationCap },
  ...
  },
  {
    ...
    items: [
      ...
      { to: "/admin/newsletter", label: "Newsletter", icon: Mailbox },
    ],
  },
  {
    label: "Outils",
  ...
  },
  {
    ...
    items: [
      ...
      { to: "/admin/member/admins", label: "Administrateurs", icon: UserStar },
    ],
  },
];
